                                ...
                                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow">
                                    <div class="flex gap-4">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex flex-wrap items-center gap-2 sm:gap-4 mt-3 text-xs text-gray-500">
                                                ...
                                                @if($post->crop)
                                                    <span class="max-w-full break-words bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded">🌿 {{ $post->crop }}</span>
                                                @endif
                                                @if($post->municipality)
                                                    <span class="max-w-full break-words bg-blue-50 text-blue-700 px-2 py-0.5 rounded">📍 {{ $post->municipality }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
